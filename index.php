...
<head>
    ...
    <title>Pendaftaran Siswa Baru | SMA Alpha</title>
...
<body>
    <header class="bg-dark text-white py-3">
        ...
        <h1 class="text-center">SMA Alpha</h1>
    </header>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Tentang SMA Alpha</h5>
                    </div>
                    <div class="card-body">
                        <p class="card-text">SMA Alpha adalah sekolah menengah atas yang berlokasi di Jakarta Selatan. Kami menawarkan program pendidikan yang berkualitas dan berfokus pada pengembangan karakter siswa.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Jl. Jend. Sudirman No. 123<br>Jakarta Selatan<br>Telepon: (021) 123-4567<br>Email: info@smaalpha.com</p>
                    </div>
                </div>
            </div>
        </div>
